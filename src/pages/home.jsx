        ...
        <div className="mt-6 grid flex-1 grid-cols-[2fr,1fr] gap-6">
          {tasks?.length === 0 ? (
            <div className="relative rounded-xl bg-zinc-900 p-6">
              ...
              <div className="absolute left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] justify-center">
                <img
                  src={ListEmpty}
                  alt="listempty"
          ...
          <div className="flex items-center justify-center rounded-xl bg-zinc-900 p-6">
